...
<body> 
	<div class="main">
		<div id="profil">
			...
			<div id="kecil">merupakan bilangan asli yang lebih besar dari angka 1, yang faktor pembaginya adalahb 1 dan bilangan itu sendiri </div>
		</div>
		<div class="nav">
		...
		<div id="footer">Dibuat dengan <i class="material-icons" id="icon1">favorite</i>oleh Riyan Adi</div>
	</div>
</body>
</html>